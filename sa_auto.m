...
preprocessingWorkflowFile = 'mouse-brain-preprocessingWorkflow.sap'; 
...
%for i = 1:length(filesToProcess)
 ...
 %       '-append')
    ...
    save(['$HOME/Documents/test/test.mat'], '-struct', 'dataRepresentation_struct', '-v7.3')
    save(['$HOME/Documents/test/test.mat'], ...
        'peaks', 'spectralChannels_all', 'spectralChannels', 'kmeans_idx', 'kmeans_c', ...
        'top1000idx', 'mean_intensity_clust1', 'mean_intensity_clust2', 'mean_intensity_all',...
        '-append')
